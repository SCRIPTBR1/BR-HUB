...
local CONFIG_FILE = "BRHub_Config.json"
...
local function resetConfig()
    ...
    -- Force-stop all active features
...
pcall(function()
    if CoreGui:FindFirstChild("BRHubGUI") then
        CoreGui.BRHubGUI:Destroy()
    end
end)
...
AutoStealBarStroke.Color = Color3.fromRGB(180, 0, 0)
...
AutoStealFill.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
...
AutoStealPercent.TextColor3 = Color3.fromRGB(255, 255, 255)
...
TopBarBottom.BackgroundColor3 = Color3.fromRGB(10, 0, 0)
...
TopBarLine.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
...
DiscordLbl.Position = UDim2.new(0, 110, 0, 0)
DiscordLbl.BackgroundTransparency = 1
DiscordLbl.Text = "discord.gg/brhub"
DiscordLbl.TextColor3 = Color3.fromRGB(200, 50, 50)
...
MinBtnStroke.Color = Color3.fromRGB(180, 0, 0)
...
Sidebar.BackgroundColor3 = Color3.fromRGB(8, 0, 0)
...
NameLine.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
...
SBDiv.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
...
TabStrip.BackgroundColor3 = Color3.fromRGB(8, 0, 0)
...
TSDiv.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
...
EnvyMini.BackgroundColor3 = Color3.fromRGB(10, 0, 0)
EnvyMini.BorderSizePixel = 0
EnvyMini.Text = "🌹 BR HUB"
...
local EnvyMiniStroke = Instance.new("UIStroke")
EnvyMiniStroke.Color = Color3.fromRGB(180, 0, 0)
EnvyMiniStroke.Thickness = 1
EnvyMiniStroke.Parent = EnvyMini
...
EnvyMini.MouseEnter:Connect(function()
    EnvyMini.BackgroundColor3 = Color3.fromRGB(30, 0, 0)
end)
...
local function hoverRow(f)
    f.MouseEnter:Connect(function()
        f.BackgroundColor3 = Color3.fromRGB(25, 0, 0)
    end)
    f.MouseLeave:Connect(function()
        f.BackgroundColor3 = Color3.fromRGB(14, 0, 0)
    end)
end
...
local function makeToggle(parent, text, order, cb)
    ...
    dot.BackgroundColor3 = Color3.fromRGB(60, 0, 0)
...
local function makeKeybind(parent, text, key, order, cb)
    ...
    kb.BackgroundColor3 = Color3.fromRGB(10, 0, 0)
    ...
    kbStroke.Color = Color3.fromRGB(180, 0, 0)
    kbStroke.Parent = kb
...
local function setTab(name)
    ...
    for n, b in pairs(tabBtns) do
        if n == name then
            ...
            b.BackgroundColor3 = Color3.fromRGB(16, 0, 0)
        end
    end
...
for i, name in ipairs(tabNames) do
    ...
    btn.BackgroundColor3 = Color3.fromRGB(16, 0, 0)
    ...
    sf.ScrollBarImageColor3 = Color3.fromRGB(180, 0, 0)
    ...
    btn.MouseEnter:Connect(function()
        if activeTab ~= name then
            btn.BackgroundColor3 = Color3.fromRGB(28, 0, 0)
        end
    end)
...
do
    ...
    ml.TextColor3 = Color3.fromRGB(200, 50, 50)
...
makeHeader(mechSF, "⚙️ GAME MECHANICS", 1)
...
makeHeader(setsSF, "⚙️ INTERFACE & BINDS", 1)
makeInput(setsSF, "UI Scale", cfg.uiScale, 2, function(v)
    cfg.uiScale = v
    UIScaleInst.Scale = v / 100
end)
makeInput(setsSF, "Panel Size", cfg.mobilePanelScale or 100, 3, function(v)
    cfg.mobilePanelScale = v
    MobPanelScale.Scale = v / 100
end)
makeKeybind(setsSF, "Hide / Show GUI", "LeftControl", 4, nil)

local lockUIFrame, lockUISetter = makeToggle(setsSF, "Lock UI", 5, function(v)
    cfg.lockUI = v
end)
...
saveBtn.BackgroundColor3 = Color3.fromRGB(200, 0, 0)
...
-- Reset Positions Button - Red Theme
local resetPosBtn = Instance.new("TextButton")
resetPosBtn.Size = UDim2.new(1, 0, 0, 36)
resetPosBtn.BackgroundColor3 = Color3.fromRGB(30, 0, 0)
...
local function updateMobileButtonStyle(button, isActive)
    if isActive then
        ...
        if button:FindFirstChild("UIStroke") then
            button.UIStroke.Color = Color3.fromRGB(255, 100, 100)
        end
    else
        button.BackgroundColor3 = Color3.new(0, 0, 0)
        button.TextColor3 = Color3.new(1, 1, 1)
        if button:FindFirstChild("UIStroke") then
            button.UIStroke.Color = Color3.fromRGB(100, 0, 0)
        end
    end
end
...
ModeLbl.Text = "Normal"
ModeLbl.TextColor3 = Color3.fromRGB(200, 50, 50)
